            ...
            {open && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-2xl overflow-hidden rounded-xl border border-white/[0.08] bg-[#050505] shadow-2xl flex flex-col"
                    >
                        <Command className="w-full bg-transparent flex flex-col h-full">
                            ...
                            <div className="flex items-center border-b border-white/[0.08] px-4 py-3">
                                ...
                                <Command.Input
                                    ...
                                    className="flex h-10 w-full rounded-md bg-transparent text-[16px] outline-none placeholder:text-white/30 text-white selection:bg-white/20 font-normal font-sans tracking-wide"
                                    autoFocus
                                />
                                <div className="ml-2 flex items-center gap-3 text-[10px] uppercase font-bold tracking-widest text-white/30">
                                    ...
                                    <span className="flex items-center justify-center px-1.5 h-5 rounded-[4px] bg-white/[0.08] border border-white/[0.05] text-[9px] text-white/50">ESC</span>
                                </div>
                            </div>

                            {/* Scrollable List with Custom Scrollbar from globals.css */}
                            <Command.List className="max-h-[360px] overflow-y-auto overflow-x-hidden p-2 scrollbar-thin">
                                <Command.Empty className="py-12 text-center text-sm text-white/40">
                                    No results found.
                                </Command.Empty>

                                <Command.Group heading="PAGES" className="text-[10px] uppercase tracking-widest text-white/30 font-semibold mb-2 px-2 mt-3 select-none">
                                ...
                                <Command.Group heading="SOCIALS" className="text-[10px] uppercase tracking-widest text-white/30 font-semibold mb-2 px-2 mt-2 select-none">
                            ...
                            {/* Footer */}
                            <div className="flex items-center justify-between px-4 py-2.5 border-t border-white/[0.08] text-[10px] text-white/30 font-medium tracking-wider uppercase bg-[#080808]">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="flex items-center gap-1.5">
                                        <span className="text-white/20 bg-white/5 px-1 py-0.5 rounded text-[9px]">↑↓</span> Navigate
                                    </span>
                                    <span className="flex items-center gap-1.5">
                                        <span className="text-white/20 bg-white/5 px-1 py-0.5 rounded text-[9px]">↵</span> Open
                                    </span>
                                </div>
                            </div>
                        </Command>
...
function CommandItem({
    ...
    return (
        <Command.Item
            onSelect={onSelect}
            className="group flex items-center px-4 py-3 mb-0.5 text-sm text-white/50 rounded-lg cursor-pointer aria-selected:bg-white/[0.08] aria-selected:text-white transition-all duration-200"
        >
            ...
            <div className="flex flex-col ml-3">
                <span className="font-medium text-[14px] text-white/80 group-aria-selected:text-white">{title}</span>
            ...
            <div className="ml-auto opacity-0 group-aria-selected:opacity-100 transition-opacity duration-200 transform translate-x-[-4px] group-aria-selected:translate-x-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white/50"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
            </div>
        </Command.Item>
    );
}
